...
Please provide the output formatted strictly as a structured research report containing the following sections:
...
4. Key Findings & Discussion (The core synthesized information from results. You MUST cite sources inline using this format: [Source Name](URL))
5. Conclusion & Limitations (Final thoughts and areas needing further research)
6. References & Timestamps (A strict bulleted list of each source used, its URL, and the search retrieval timestamp provided in the data).

Write in an informative, objective academic style. When referencing information, rely entirely on the provided search results and always cite the URLs inline."""
